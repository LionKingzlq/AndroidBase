...
public class HttpConfig {
	...
	public static final String DEFAULTCOOKIEKEY = "Set-Cookie";
	
	public static final int HTTP_RESPONSE_DATA_TYPE_JSON = 1;
	public static final int HTTP_RESPONSE_DATA_TYPE_STRING = 2;
	
	public static final int HTTP_DECRYPTTYPE_NONE = 0;
	public static final int HTTP_DECRYPTTYPE_DES = 1;
	public static final int HTTP_DECRYPTTYPE_AES = 2;
	...
	private static String MODEL_UA = null;
	...
	public static String serialNumber(){
		if(SERIALNUMBER == null){
			SERIALNUMBER = DeviceUtils.sn();
		}
		return SERIALNUMBER;
	}
	
	public static String modelsAbility(){
		if(MODEL_UA == null){
			try {
