...
public class SwipeListView extends ListView {  
    ...
    private boolean canRLSwipe = false;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {  
        ...
        switch (ev.getAction()) {  
            case MotionEvent.ACTION_DOWN:  
                ...
                logger.e("motionPosition----" + motionPosition + "getFirstVisiblePosition()---"+getFirstVisiblePosition());
                if (motionPosition >= 0) {  
                    View currentItemView = getChildAt(motionPosition - getFirstVisiblePosition());  
                    Object obj =  getItemAtPosition(motionPosition);
                    if(obj!=null && obj instanceof ISwipeData){
                    	 canRLSwipe = ((ISwipeData)obj).itemCanSwipe();
                    }
                    //logger.e(canRLSwipe);
                    //logger.e(obj);
    ...
    private boolean judgeScrollDirection(float dx, float dy) {  
        ...
        if (Math.abs(dx) > 30 && Math.abs(dx) > 2 * Math.abs(dy)) {  
            mIsHorizontal = true;  
            logger.d("mIsHorizontal---->" + mIsHorizontal);  
