...
public class FrescoConfig {
    ...
    public static final String IMAGE_CACHE_PATH = DirUtils.getInstance().getCachePhotoPath();
    public static final String IMAGE_PIPELINE_CACHE_DIR = "fresco_cache";//默认图所放路径的文件夹名
    ...
    private static ImagePipelineConfig configureCaches(Context context) {
        ...
        DiskCacheConfig diskSmallCacheConfig =  DiskCacheConfig.newBuilder()
                ...
                .setBaseDirectoryPath(new File(IMAGE_CACHE_PATH))//缓存图片基路径
...
//            .setFadeDuration(fadeDuration)//fresco:fadeDuration="300"加载图片动画时间
                .setFailureImage(sErrorDrawable)//fresco:failureImage="@drawable/error"失败图
...
//            .setOverlays(overlays)
                .setPlaceholderImage(sPlaceholderDrawable)//fresco:placeholderImage="@color/wait_color"占位图
